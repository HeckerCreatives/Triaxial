...
export default function Yourworkload() {
  ...
  const getList = async () => {
    const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/projectinvoice/employeelistcomponentprojectinvoice?projectid=${id}`,{
  ...
  const updateInvoiceValue = async () => {
    try {
      const request = axios.post(`${process.env.NEXT_PUBLIC_API_URL}/projectinvoice/employeesaveprojectinvoicevalue`,{
      ...
      {list.length !== 0 ? (
          ...
          <div className=' overflow-x-auto'>
            <table className="table-auto border-collapse ">
              <thead className=' w-[800px] bg-zinc-800 h-[100px]'>
                <tr className=' text-[0.6rem] text-zinc-100 font-normal'>
