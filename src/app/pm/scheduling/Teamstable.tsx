      ...
      <div className=' w-full flex flex-col max-w-[1520px]'>
        ...
        <TableBody>
          {teamlist.map((item, index) => (
            ...
            <TableCell className="">
              <a href={`/pm/graph/jobcomponent?teamid=${item.teamid}&teamname=${item.teamname}`} className=' w-fit bg-red-700 rounded-sm p-2 text-white flex items-center gap-2'>View<Eye size={15}/></a>
            </TableCell>
{/* 
            <TableCell>
