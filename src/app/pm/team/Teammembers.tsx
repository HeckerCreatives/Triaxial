    ...
    <div className=' w-full h-full flex justify-center bg-secondary p-6 text-zinc-100'>
      ...
      <div className=' w-full flex flex-col max-w-[1520px]'>
        ...
        <TableHeader>
            ...
            <TableHead>Total Hours for the Week</TableHead>
        ...
        <TableBody>
            ...
            <TableCell>
                <button onClick={() => router.push('?active=individual workload')} className=' p-2 rounded-sm bg-red-700 text-xs text-white'>View</button>
            </TableCell>
