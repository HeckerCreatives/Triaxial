      ...
      <div className=' w-full flex items-center justify-between h-auto bg-primary mb-2 p-4 text-xs'>
        ...
        <div className=' flex flex-col'>
          ...
          <div className=' flex items-center gap-2 text-xs mt-2'>
            ...
            <DropdownMenuContent className=' bg-secondary border-none text-zinc-100 text-[.5rem]'>
                  ...
                  {member.dates?.map((dateObj, dateIndex) => {
                      ...
                      return (
                        <>
                          <td 
                            key={dateIndex} 
                            className="relative text-center overflow-hidden bg-primary cursor-pointer"
                            onClick={() => {
                              setDialog(true);
                              setIndex(dateIndex);
