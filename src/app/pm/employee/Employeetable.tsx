            ...
            <TableCell className=" flex items-center gap-2">
              ...
              <Dialog open={dialog2} onOpenChange={setDialog2}>
                ...
                <DialogContent className=' bg-secondary border-none text-zinc-100 grid grid-cols-1 lg:grid-cols-[250px,1fr]'>
                  ...
                  >
                    <p className=' p-2 uppercase text-lg font-semibold mt-8 bg-gradient-to-r from-zinc-950 to-zinc-950/10'>View</p>
                  </div>
              ...
              <Button onClick={() => setDialog2(false)} name={'Set View'}/>
            </TableCell>
