...
export default function Financetable() {
  ...
  return (
    <div className=' w-full h-full flex justify-center bg-secondary p-6 text-zinc-100 mt-[150px]'>
      ...
      <div className=' w-full flex flex-col max-w-[1520px]'>
        <div className=' flex md:flex-row flex-col items-center justify-between gap-4'>
            <div className=' flex  items-center gap-4'>
              <Dialog open={dialog} onOpenChange={setDialog}>
                <DialogTrigger>
                  <button className=' bg-red-700 px-6 py-2 rounded-sm flex items-center gap-1 text-xs'><ArrowUp size={15}/>Assign</button>
                </DialogTrigger>
                <DialogContent className=' bg-secondary border-none text-zinc-100 grid grid-cols-1 lg:grid-cols-[250px,1fr]'>
                  ...
                  >
                    <p className=' p-2 uppercase text-sm font-semibold mt-8 bg-gradient-to-r from-zinc-950 to-zinc-950/10'>Assign To Finance</p>
                  </div>
        ...
        <TableHeader>
            ...
            <TableHead>Finance Staff Id</TableHead>
            <TableHead>Finance Staff Name</TableHead>
