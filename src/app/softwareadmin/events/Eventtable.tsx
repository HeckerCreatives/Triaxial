                  ...
                  <form action="" className=' flex flex-col '>
                    ...
                    <div className=' grid grid-cols-1 gap-4'>
                      <div className=' flex flex-col gap-1'>
                        ...
                        <Input placeholder='Event Title' type='text' className=' bg-primary h-[35px] text-xs'/>

                        <label htmlFor="" className=' mt-2 text-xs'>Start date</label>
                        <Input placeholder='Start date' type='date' className=' bg-primary h-[35px] text-xs'/>

                        <label htmlFor="" className=' mt-2 text-xs'>End Date</label>
                        <Input placeholder='End Date' type='date' className=' bg-primary h-[35px] text-xs'/>
                      </div>
                ...
                <DialogContent className=' bg-secondary border-none text-zinc-100 grid grid-cols-1 lg:grid-cols-[250px,1fr]'>
                  ...
                  <form action="" className=' flex flex-col '>
                    ...
                    <div className=' grid grid-cols-1 gap-4'>
                      <div className=' flex flex-col gap-1'>
                        <label htmlFor="" className=' mt-2 text-xs'>Event Title</label>
                        <Input placeholder='Event Title' type='text' className=' bg-primary text-xs'/>

                        <label htmlFor="" className=' mt-2 text-xs'>Start date</label>
                        <Input placeholder='Start date' type='date' className=' bg-primary text-xs'/>

                        <label htmlFor="" className=' mt-2 text-xs'>End Date</label>
                        <Input placeholder='End Date' type='date' className=' bg-primary text-xs'/>
                      </div>
