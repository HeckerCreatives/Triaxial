  ...
  return (
     <div className="  relative z-10 mt-20 w-full flex max-w-[1520px] flex-col items-center justify-center px-4">
      ...
      <div className=" w-auto flex items-center flex-wrap gap-4">
        <Cardmedium name={'Total Hr'} value={'0'} icon={<Users size={50} className=" text-red-700"/>}/>
        <Cardmedium name={'Active Hr'} value={'0'} icon={<User size={50} className=" text-red-700"/>}/>
        <Cardmedium name={'Banned Hr'} value={'0'} icon={<CircleAlert size={50} className=" text-red-700"/>}/>
