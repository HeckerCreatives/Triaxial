              ...
              graphItem.members.map((member, memberIndex) => (
                <tr key={`${graphIndex}-${memberIndex}`} className="bg-primary text-[.5rem] py-2 h-[35px] border-[1px] border-zinc-600 text-left border-collapse">
                  ...
                  <td className="text-left whitespace-normal break-all border-[1px] border-zinc-600 px-2">
                    <a href={`/superadmin/individualworkload?employeeid=${member.id}&name=${member.name}&teamname=${graphItem.name}`} className=' underline'>{member.initial}</a>
                  </td>
                    ...
                    <React.Fragment key={index}>
                      ...
                      {(index + 1) % 5 === 0 && (
                        <th
                          ...
                          className="font-normal max-w-[25px] border-[1px] bg-primary border-zinc-700"
                        >
                          <p className="-rotate-90 max-w-[25px] ml-[8px] font-bold text-white">Total Hours</p>
                        </th>
                      )}
                    </React.Fragment>
                  );
                      ...
                      {dates.map((date, dateIndex) => {
                        ...
                        return (
                          <React.Fragment key={dateIndex}>
                            ...
                            <td
                              className={`relative max-w-[20px] text-center overflow-hidden bg-white border-[1px] ${
                            ...
                            {(dateIndex + 1) % 5 === 0 && (
                              ...
                              >
                                <p className="text-white text-[.5rem] font-semibold">{totalHours.toLocaleString() || '-'}</p>
                              </th>
                            )}
                          </React.Fragment>
                        );
