        ...
        <TableBody>
          {list.map((item, index) => (
            ...
            <TableCell className=" flex items-center gap-2">
              <button onClick={() => router.push(`/superadmin/invoiceprojection?jobcomponentid=${item._id}`)} className=' bg-red-600 p-2 text-white rounded-sm flex items-center gap-2'><Eye size={15}/>View Invoice Projection</button>
