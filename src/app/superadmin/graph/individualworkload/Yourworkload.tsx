...
export default function Indiviualworkloads() {
  ...
  const isDateInRange = (dateToCheck: string, startDate: string, endDate: string): boolean => {
   ...
   const statusColor = (data: string[], date: string, hours: number, eventStart: string, eventEnd: string, eventDates: Event[], leaveDates: Leave[], wellnessDates: string[],wfhDates: string []) => {
