                                                ...
                                                <tbody>
                                                  {listRequest[0]?.members.map((item, graphIndex) =>
                                                      <tr key={`${graphIndex}`} className="bg-primary text-[.5rem] py-2 h-[30px] border-[1px] border-zinc-600">
                                                        ...
                                                        <td className=' border-[1px] border-zinc-600 px-1'></td>
                                                        <td className=' border-[1px] border-zinc-600 px-1'></td>
                                                        <td onClick={() => router.push(`/superadmin/individualworkload?employeeid=${item.id}&name=${item.name}&teamname=${listRequest[0].name}`)} className=" border-[1px] border-zinc-600 px-2 text-start cursor-pointer underline text-blue-400">{item.initial}</td>
                                                        <td></td>
