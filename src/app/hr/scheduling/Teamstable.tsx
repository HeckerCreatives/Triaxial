      ...
      <div className=' w-full flex flex-col max-w-[1520px]'>
        ...
        <TableBody>
          {teamlist.map((item, index) => (
            ...
            <TableCell className="">
              <a href={`/hr/graph/jobcomponent?teamid=${item.teamid}`} className=' w-fit bg-red-700 rounded-sm p-2 text-white flex items-center gap-1'><Eye size={15}/>View</a>
            </TableCell>

             <TableCell>
                <Viewbtn disabled={false} name='View' onClick={() => router.push(`/hr/graph/teammembers?teamid=${item.teamid}`)}/>
              </TableCell>
