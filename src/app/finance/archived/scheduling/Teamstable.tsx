      ...
      <div className=' w-full flex flex-col max-w-[1520px]'>
        ...
        <TableBody>
          {teamlist.map((item, index) => (
            ...
            <TableCell className="">
              <a href={`/finance/archived/scheduling/jobcomponent?teamid=${item.teamid}`} className=' w-fit bg-red-700 rounded-sm p-1 text-white flex items-center gap-2'>Job Component<Eye size={15}/></a>
            </TableCell>
