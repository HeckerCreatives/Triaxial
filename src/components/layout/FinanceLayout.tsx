            ...
            <div className="flex-1 mt-4 overflow-y-auto">
              ...
              {finance.map((item, index) => (
                  ...
                  {item.subpath.length === 0 ? (
                    ...
                    key={index}
                      href={item.path}
                      className={` group ${(path.includes(item.path) && path !== '/finance/noaccess/') ? ' text-red-700' : 'text-zinc-100'}  text-sm flex items-center gap-3 rounded-lg px-3  py-2 transition-all hover:text-red-700`}
                    >
                      {item.icon}
                      {item.name}
                    ...
                    <Accordion type="single" collapsible>
                      <AccordionItem value="item-1">
                        <div className={` px-3 flex items-center w-full gap-2 hover:text-red-700 ${(path.includes(item.path) && path !== '/finance/noaccess/') ? ' text-red-700' : 'text-zinc-100'}`}>
                          {item.icon}
                        ...
                        <AccordionContent className=' pl-8'>
                          {item.subpath.map((item, index) => (
                           ...
                           {item.subpath.length === 0 ? (
                              ...
                              key={index}
                              href={item.path}
                              className={` group ${(path.includes(item.path) && path !== '/finance/noaccess/') ? ' text-red-700' : 'text-zinc-100'} text-muted-foreground text-sm flex items-center gap-3 rounded-lg px-3  py-2 transition-all hover:text-red-700`}
                            >
