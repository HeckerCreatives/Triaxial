          ...
          <label htmlFor="" className=' mt-6'>Current password</label>
            <div className=' relative w-full'>
                <Input type={showc} className=' text-xs h-[35px] bg-secondary' placeholder='Current password' {...register('cpassword')} />
                    ...
                    <p onClick={() => setShowc('password')} className=' absolute right-1 top-[6px] bg-slate-300 p-1 rounded-sm text-black cursor-pointer'><Eye size={15}/></p>
                    )}
          ...
          <label htmlFor="" className=''>New password</label>
            ...
            <div className=' relative w-full'>
                <Input type={shownew} className=' text-xs h-[35px] bg-secondary' placeholder='New password' {...register('newpassword')} />
                    ...
                    <p onClick={() => setShownew('password')} className=' absolute right-1 top-[6px] bg-slate-300 p-1 rounded-sm text-black cursor-pointer'><Eye size={15}/></p>
                    )}
                ...
                <Input type={showconfirm} className=' text-xs h-[35px] bg-secondary' placeholder='Confirm password' {...register('confirmpassword')} />
                    ...
                    {showconfirm === 'password' ? 
                        (
                        <p onClick={() => setShowconfirm('text')} className=' absolute right-1 top-[6px] bg-slate-300 p-1 rounded-sm text-black cursor-pointer'><EyeOff size={15}/></p>
                        ):(
                        <p onClick={() => setShowconfirm('password')} className=' absolute right-1 top-[6px] bg-slate-300 p-1 rounded-sm text-black cursor-pointer'><Eye size={15}/></p>
                    )}
